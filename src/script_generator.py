...
- 見せ方: 「ニュース番組」ではなく「仲良しギャル2人の、朝のいつものおしゃべり」。ニュースを読み上げるのではなく、2人が友達同士の日常会話の中で「ねえ聞いて」と今日の話題を紹介し合う。リスナーは、仲良しの友達のおしゃべりを横で聞いているような感覚になれること。
...
【日常会話スタイルのルール（最重要）】
この番組は「ニュース原稿を読む放送」ではなく「ギャル2人の日常のおしゃべり」です。以下を必ず守ってください。
- すべてのニュースは、原稿の読み上げではなく「ねえ聞いて、昨日スマホ見てたらさ」「てかこれ知ってる？」「朝メイクしながら見てビビったんだけど」のような、友達に話しかける振りから入る。
- 「続いてはビジネスの話題です」「次のニュースです」のような番組進行のアナウンスは禁止。話題の切り替えは「てか全然違う話なんだけどさ」「あ、それで思い出したんだけど」「ちょっと話変わるけど聞いて」のような日常会話の転換でつなぐ。ただし、何の話に変わったかは、その転換の一言で必ず分かるようにする。
- 各ニュースで1回は、自分たちの日常に置き換えるたとえやツッコミを入れる（例：「うちらで言うと、朝の支度を全部友達が代わりにやってくれる感じでしょ」）。難しい話ほど、うちらの生活のどこに関係あるかまで落とす。
- オープニングや話題のつなぎで、朝の支度・寝坊・カフェ・推し活・ネイルのような軽い日常ネタを一言入れてよい。ただし1〜2文の短さにとどめ、実在の店名・商品名・人物を体験談として語らない（「コンビニの新作」「駅前のカフェ」のような一般的な言い方ならOK）。
- 1人が3文以上連続で説明しない。長い説明は、相手のあいづち・食い気味の質問・オウム返し・ツッコミで細かく区切り、常に会話のキャッチボールにする。
- 日常ネタ・雑談は合計で全体の2割まで。残り8割はニュースの中身（何が起きたか・なぜ話題か・誰が知っておくと得か）をしっかり伝える。事実の正確さのルールは日常会話スタイルでも一切ゆるめない。
...
- ニュースが原稿の読み上げ調ではなく、友達に話しかける日常会話の振りから始まっているか。
- 「続いては◯◯の話題です」のような番組進行アナウンスが残っていないか（日常会話の転換になっているか）。
- 日常ネタ・雑談が全体の2割以内で、ニュースの中身がしっかり伝わるか。
